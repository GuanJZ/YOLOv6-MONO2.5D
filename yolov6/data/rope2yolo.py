...
sys.path = ['/data3/junzhi/projects/YOLOv6_MONO2.5D'] + sys.path
# sys.path = ["/media/junzhi/8e78e258-6a68-4733-8ec2-b837743b11e6/workspace/github/YOLOv6-MONO2.5D"] + sys.path
